        ...
        SizedBox(
          ...
          child: AspectRatio(
            ...
            child: Hero(
              ...
              child: Image.network(widget.product.pictures[selectedImage],),
            ),
          ),
        ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: oldWaveColor.withOpacity(selectedImage == index ? 1 : 0)),
        ),
        child: Image.network(widget.product.pictures[index]),
      ),
    );
  }
}
